...
if (isset($_POST["add"])) {
 ...
 $sql= "INSERT INTO `fee`(`Fee_category`, `Amount`) VALUES ('$categ','$amt') ";
...
<div class="container">
    ...
    <div class="signup-form">
        <h3>Enter New Fee</h3>
        <form class="box-form2" action="newFee.php" method="POST">
        <input type="text" id="categ" name="categ" placeholder="Enter Fee Category" required>
        <input type="text" id="signup-name" name="amt" placeholder="Enter Fee Amount" required>
        
        
            <div class="box-btn">
        <button class="btn-login" name="add" type="submit" value="enter">Add</button>
      </div>
        </form>
    </div>
